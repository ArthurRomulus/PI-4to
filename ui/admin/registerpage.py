...
class RegisterPage(QWidget):
    def __init__(self, on_open_register):
        ...
        title = QLabel("Registro de usuarios")
        title.setStyleSheet("color: #38bdf8; font-size: 18px; font-weight: 800;")
        desc = QLabel("Sistema de registro de usuarios (reconocimiento facial deshabilitado)")
        ...
        btn.setEnabled(False)  # Deshabilitado porque face recognition fue eliminado
        btn.setText("Registro deshabilitado (face recognition eliminado)")
